...
function WhatIs() {
  ...
  <br/>
    <li>
      <a title="buying a car "href="#section-buying-a-car" class="btn btn-outline-success"> Buying  a car  </a>
    </li>
    <br/>
    <li>
    <a title="Selling a car "href="#section-selling-a-car" class="btn btn-outline-success"> Selling a car  </a>
    </li>
    <br/>
    <li>
    <a title="Finalization the Sale  "href="#section-finalizing-sale" class="btn btn-outline-success"> Finalization the Sale </a>
    </li>
    <br/>
  </ul>
</li>
...
<h1 className='line'>____</h1>
  <h2 id='section-about-us' class="btn btn-outline-success"> About Us </h2>
...
<h2 id ="section-how-it-works"class="btn btn-outline-success">How It Works</h2>
<h1 className='line'>___</h1>
<h3 id ="section-buying-a-car"class="btn btn-outline-success"> Buying a Car</h3>
...
<p>Once you’ve found a car you’re interested in,<br/>
 ...
 <h4 class="btn btn-outline-success">1. Register to Bid</h4>
 <p>To contact the seller directly and place bids,<br/>
   you must first Register to Bid  with a valid credit card and phone number.<br/>
    ...
    <h4 class="btn btn-outline-success">2. Perform Due Diligence </h4>
    <p>While we’ve tried to make buying a car online as safe and easy as possible,<br/>
       ...
       <h4 class="btn btn-outline-success">3. Arrange Financing and Logistics</h4>
      ...
      <h4 class="btn btn-outline-success">4.Bid</h4>
      ...
      <h4> class="btn btn-outline-success"5. Win the Auction</h4>
      ...
      <h1 className='line'>____</h1>
<h3 id="section-selling-a-car" class="btn btn-outline-success"> Selling a Car </h3>

<p>Cars & Bids is the best place to sell your modern enthusiast car – and we’ve made the process easy.</p>
<h4 class="btn btn-outline-success"> 1.Submit Your Car</h4>
...
<h4 class="btn btn-outline-success">2. Prepare Your Listing</h4>
...
<h4 class="btn btn-outline-success">3. Finalize Your Auction</h4>
...
<h4 class="btn btn-outline-success"> 4. Participate in the Auction</h4>
<ul>
...
<h4 class="btn btn-outline-success">5. Auction End </h4>
...
<h1 className='line'>____</h1>
<h3 id="section-finalizing-sale"class="btn btn-outline-success">Finalizing the Sale </h3>
...
<h4 class="btn btn-outline-success">1. Make Contact</h4>
<ul>
...
<h4 class="btn btn-outline-success">2. Payment & Documentation</h4>
<ul>
...
<h4 class="btn btn-outline-success">3. Share your Success Story</h4>
...
<div className="container-fluid">
  <div className="review-wrap">
    ...
    <h1 className='line'>____</h1>
      <h4 class="btn btn-outline-success"> Why HetSoumek </h4>
    ...
    <h6 class="btn btn-outline-success"> Our customers love Us</h6>
